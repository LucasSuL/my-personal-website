...
function useSubmitGoogleSheet() {
    ...
    const submitHandler = async (e) => {
        ...
        try {
            ...
            if (response.ok) {
                ...
                setModalMessage({ head: "Hi!", body: "Thank you for reaching out! I will respond to you as soon as possible." });
                setEmail('')
                setMsg('')
                console.log('111')
            } else {
    ...
    return { modalMessage, email, setEmail, msg, setMsg, isPending, isFormSubmitted, setIsFormSubmitted, submitHandler };
}
