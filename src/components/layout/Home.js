...
export default function Hero() {
    ...
    return (
        <div>
            <Navbar />
            <section class="container-fluid vh-100 cust-hero p-0" style={{ backgroundSize: `${backgroundSize}` }} >
                <div class="container" style={{ maxWidth: "1400px", paddingTop: "80px" }}>
                    ...
                    <div class="container d-flex justify-content-evenly w-75 cust-hero-badge" >
                        <a
